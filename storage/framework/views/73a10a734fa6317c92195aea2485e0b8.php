...
<body class="bg-white text-gray-800 m-0 p-0 font-sans h-screen flex flex-col md:flex-row overflow-hidden">
    ...
    <div class="hidden md:flex flex-col justify-between w-1/2 p-10 lg:p-16 relative md:rounded-r-[3rem] shadow-2xl overflow-hidden" style="background-color: #C7F0DE;">
        ...
        <div class="relative z-10 flex items-center gap-3">
            <img src="<?php echo e(asset('logo.png')); ?>" alt="Logo" class="h-20 p-1 rounded">
        </div>
    ...
    <div class="w-full md:w-1/2 flex flex-col justify-center p-8 lg:p-20 relative h-full overflow-y-auto">
        ...
        <div class="md:hidden flex justify-center items-center gap-2 mb-10">
            <img src="<?php echo e(asset('logo.png')); ?>" alt="Logo" class="h-10">
        </div>
        ...
        <div class="max-w-md w-full mx-auto">
            ...
            <div class="my-6">
                <a href="<?php echo e(route('download.report')); ?>" class="w-full flex justify-center items-center py-3.5 px-4 border-2 border-gray-100 rounded-xl text-xs font-bold text-gray-600 hover:text-brand-dark hover:bg-gray-50 hover:border-gray-200 transition">
        ...
        <div class="absolute top-6 right-6 hidden md:block text-sm font-semibold text-gray-500 hover:text-brand-primary transition">
            <a href="<?php echo e(route('home')); ?>"><i class="fas fa-arrow-left mr-1"></i> Back to Home</a>
        </div>
    </div>

</body>
</html>
<?php /**PATH D:\laravel\outsourcelab\resources\views/lis-login.blade.php ENDPATH**/ ?>