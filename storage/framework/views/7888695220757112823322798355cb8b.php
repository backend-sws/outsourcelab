            ...
            <div class="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="prescription_member" value="self" class="peer hidden" checked 
                                data-name="<?php echo e($profile['name'] ?? 'Self'); ?>" 
                                data-age="<?php echo e($profile['age'] ?? 30); ?>" 
                                data-gender="<?php echo e($profile['gender'] ?? 'Male'); ?>" 
                ...
                <div class="bg-blue-50/50 rounded-xl p-5 border border-blue-100 mb-8 flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-lg font-black text-brand-dark" id="displayMemberName"><?php echo e($profile['name']); ?></h3>
                    </div>
                    <div class="text-right">
                        <p class="text-sm font-bold text-gray-600" id="displayMemberAge"><?php echo e($profile['age'] ?? 30); ?> Years</p>
                        <p class="text-sm font-bold text-gray-600" id="displayMemberGender"><?php echo e($profile['gender'] ?? 'Male'); ?></p>
                    </div>
                </div>
                        ...
                        <div class="flex items-center justify-between p-4 border border-gray-200 rounded-xl bg-gray-50/30">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 font-semibold mt-0.5">Uploaded for <?php echo e($profile['name']); ?> • 12 Jan 2023</p>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\lab\lab\resources\views/patient/prescriptions.blade.php ENDPATH**/ ?>