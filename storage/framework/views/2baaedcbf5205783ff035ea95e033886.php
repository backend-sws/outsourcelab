                    ...
                    <div class="bg-white rounded-[2rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col justify-between hover:-translate-y-1 hover:shadow-[0_12px_35px_rgb(0,0,0,0.08)] transition-all duration-300 relative group overflow-hidden h-full">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between items-center mb-3">
                                <span class="bg-teal-50 text-teal-700 text-[10px] font-bold px-2.5 py-1 rounded-full border border-teal-200/60 uppercase tracking-wider">
                                    <?php echo e($test->category->name ?? 'Single Test'); ?>
                            ...
                            <!-- Test Name -->
                            <h3 class="font-bold text-gray-900 text-sm leading-snug mb-3 group-hover:text-brand-secondary transition-colors line-clamp-2 min-h-[40px]" title="<?php echo e($test->name); ?>">
...
<?php /**PATH D:\laravel\outsourcelab\resources\views/partials/single-tests-section.blade.php ENDPATH**/ ?>