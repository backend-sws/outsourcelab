<?php $__env->startSection('content'); ?>
    <div style="text-align: center; margin-bottom: 24px;">
        ...
        <p style="margin: 0; color: #64748b; font-size: 14px;">
            Hello <strong><?php echo e($booking->patient?->name ?? 'Valued Customer'); ?></strong>, your booking <strong>#<?php echo e($booking->booking_reference); ?></strong> has been cancelled.
        </p>
    </div>
    ...
    <div style="text-align: center; margin-top: 24px;">
        <a href="<?php echo e(url('/')); ?>" class="btn">Book Another Test</a>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('emails.layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Employee\Desktop\outsourcelab\resources\views/emails/booking-cancelled-customer.blade.php ENDPATH**/ ?>