        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                ...
                <div class="col-span-1 md:col-span-1 pr-4">
                    <img src="<?php echo e(asset('logo.jpeg')); ?>" alt="Logo" class="h-10 mb-6 bg-white/10 p-2 rounded">
                    ...
                    <div class="flex items-center space-x-3 bg-white/5 p-3 rounded-lg border border-white/10">
                        <img src="https://via.placeholder.com/40/ffd700/000?text=Gold" alt="Quality" class="w-10 h-10 rounded-full">
                        <p class="text-[10px] font-bold text-gray-300 leading-tight">We are committed to deliver<br>highest quality standards and<br>exceptional customer service</p>
                    </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-4 mb-8">
                        <a href="#" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-instagram"></i></a>
                        <a href="#" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-facebook-f"></i></a>
                        <a href="#" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-twitter"></i></a>
                        <a href="#" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-linkedin-in"></i></a>
                        <a href="#" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-xs text-gray-300">
                        <li class="flex items-start">
                            <i class="far fa-envelope mt-1 mr-3 text-brand-secondary"></i>
                            <a href="mailto:care@avwellcarediagnostics.com" class="hover:text-white transition">care@avwellcarediagnostics.com</a>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-phone-alt mt-1 mr-3 text-brand-secondary"></i>
                            <a href="tel:8988988787" class="hover:text-white transition font-bold text-white">898 898 8787</a>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-map-marker-alt mt-1 mr-3 text-brand-secondary"></i>
                            <div>
                                <strong class="text-white block mb-1">Av Wellcare Lifetech Pvt. Ltd.</strong>
                                <p class="mb-2"><strong>Registered Address:</strong><br>H-21, 2nd Floor, Electronic City, H Block, Sector 63, Noida, Uttar Pradesh 201301</p>
                                <p><strong>National Reference Lab:</strong><br>H-21, 4th Floor, Electronic City, H Block, Sector 63, Noida, Uttar Pradesh 201301</p>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-400">
                <p>Av Wellcare Diagnostics Â© 2024. All rights reserved.</p>
                <p>CIN: U85190UP2021PTC149892</p>
...
<?php /**PATH D:\laravel\outsourcelab\resources\views/partials/footer.blade.php ENDPATH**/ ?>