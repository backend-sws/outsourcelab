...
<div class="w-full md:w-1/3 lg:w-1/4 space-y-4">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm flex items-center justify-between">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h4 class="font-extrabold text-brand-dark"><?php echo e($userName); ?></h4>
                <p class="text-xs text-gray-500 font-medium">+91 <?php echo e($userMobile); ?></p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        ...
        <ul class="text-sm font-semibold text-gray-700 divide-y divide-gray-100">
            ...
            <li><a href="<?php echo e(route('patient.transactions')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition <?php echo e(request()->routeIs('patient.transactions*') ? 'text-brand-secondary bg-gray-50 font-bold' : ''); ?>"><span class="flex items-center"><i class="fas fa-receipt w-6 <?php echo e(request()->routeIs('patient.transactions*') ? 'text-brand-secondary' : 'text-gray-400'); ?>"></i> Payment History</span> <i class="fas fa-chevron-right text-gray-300 text-xs"></i></a></li>
            ...
            <li>
                <a href="<?php echo e(route('patient.notifications')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition <?php echo e(request()->routeIs('patient.notifications*') ? 'text-brand-secondary bg-gray-50 font-bold' : ''); ?>">
                    <span class="flex items-center">
                        <i class="fas fa-bell w-6 <?php echo e(request()->routeIs('patient.notifications*') ? 'text-brand-secondary' : 'text-teal-600'); ?>"></i> 
                    ...
                    <?php if($sidebarUnreadCount > 0): ?>
                        <span class="px-2 py-0.5 rounded-full text-[10px] font-black bg-rose-500 text-white animate-pulse"><?php echo e($sidebarUnreadCount); ?></span>
                    <?php else: ?>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        ...
        <ul class="text-sm font-semibold text-gray-700 divide-y divide-gray-100">
            ...
            <li><a href="<?php echo e(route('patient.coupons')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition"><span class="flex items-center"><i class="fas fa-gift w-6 text-gray-400"></i> My Gift Card</span> <i class="fas fa-chevron-right text-gray-300 text-xs"></i></a></li>
            <li><a href="<?php echo e(route('patient.membership')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition"><span class="flex items-center"><i class="fas fa-heartbeat w-6 text-gray-400"></i> One Health</span> <i class="fas fa-chevron-right text-gray-300 text-xs"></i></a></li>
            <li><a href="<?php echo e(route('calculators.bmi')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition"><span class="flex items-center"><i class="fas fa-utensils w-6 text-gray-400"></i> Diet Plan</span> <i class="fas fa-chevron-right text-gray-300 text-xs"></i></a></li>
            <li><a href="<?php echo e(route('calculators.index')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition"><span class="flex items-center"><i class="fas fa-weight w-6 text-gray-400"></i> Measure Your Health</span> <i class="fas fa-chevron-right text-gray-300 text-xs"></i></a></li>
            <li><a href="<?php echo e(route('faqs')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition"><span class="flex items-center"><i class="far fa-question-circle w-6 text-gray-400"></i> Queries & Tickets</span> <i class="fas fa-chevron-right text-gray-300 text-xs"></i></a></li>
        </ul>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        ...
        <ul class="text-sm font-semibold text-gray-700 divide-y divide-gray-100">
            <li><a href="<?php echo e(route('privacy')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition"><span class="flex items-center"><i class="fas fa-shield-alt w-6 text-gray-400"></i> Privacy Policy</span> <i class="fas fa-chevron-right text-gray-300 text-xs"></i></a></li>
            <li><a href="<?php echo e(route('patient.profile.edit')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition"><span class="flex items-center"><i class="fas fa-cog w-6 text-gray-400"></i> Account Settings</span> <i class="fas fa-chevron-right text-gray-300 text-xs"></i></a></li>
            <li><a href="<?php echo e(route('terms')); ?>" class="flex justify-between items-center p-4 hover:bg-gray-50 transition"><span class="flex items-center"><i class="fas fa-file-contract w-6 text-gray-400"></i> Terms & Conditions</span> <i class="fas fa-chevron-right text-gray-300 text-xs"></i></a></li>
        </ul>
    </div>
