...
<body class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden text-slate-100 selection:bg-indigo-500 selection:text-white">
    ...
    <div class="max-w-md w-full relative z-10">
            ...
            <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" value="password123" class="w-full pl-11 pr-4 py-3 bg-white/[0.04] border border-white/[0.08] rounded-xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition text-sm text-white placeholder-slate-500" placeholder="••••••••" required>
                    </div>
                </div>
        ...
        <div class="text-center mt-6 text-xs text-slate-500">
            &copy; <?php echo e(date('Y')); ?> WellCare Diagnostic Labs. All rights reserved.
        </div>
    </div>

</body>
</html>
<?php /**PATH D:\laravel\outsourcelab\resources\views/admin/login.blade.php ENDPATH**/ ?>