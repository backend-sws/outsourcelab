...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="glass-card rounded-2xl p-5 border border-slate-200/80 dark:border-white/10 relative overflow-hidden">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-[11px] text-slate-500 font-mono"><?php echo e($channels['email']['from']); ?></span>
                    </div>
                </div>
            ...
            <div class="mt-3 pt-3 border-t border-slate-100 dark:border-white/5 flex items-center justify-between text-xs text-slate-500">
                <span>Mailer: <strong class="text-slate-700 dark:text-slate-300 font-mono"><?php echo e($channels['email']['mailer']); ?></strong></span>
                <span><strong><?php echo e(number_format($totalEmail)); ?></strong> logs</span>
            </div>
        </div>
        ...
        <div class="glass-card rounded-2xl p-5 border border-slate-200/80 dark:border-white/10 relative overflow-hidden">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-[11px] text-slate-500">Provider: <?php echo e(strtoupper($channels['sms']['provider'])); ?></span>
                    </div>
                </div>
                <?php if($channels['sms']['enabled'] && $channels['sms']['ready']): ?>
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400">
            ...
            <div class="mt-3 pt-3 border-t border-slate-100 dark:border-white/5 flex items-center justify-between text-xs text-slate-500">
                ...
                <span><strong><?php echo e(number_format($totalSms)); ?></strong> logs</span>
            </div>
        </div>
        ...
        <div class="glass-card rounded-2xl p-5 border border-slate-200/80 dark:border-white/10 relative overflow-hidden">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-[11px] text-slate-500">Provider: <?php echo e(ucfirst($channels['whatsapp']['provider'])); ?></span>
                    </div>
                </div>
                <?php if($channels['whatsapp']['enabled'] && $channels['whatsapp']['ready']): ?>
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400">
                        <i class="fas fa-circle-check text-[9px]"></i> Ready
                    </span>
                <?php else: ?>
            ...
            <div class="mt-3 pt-3 border-t border-slate-100 dark:border-white/5 flex items-center justify-between text-xs text-slate-500">
                ...
                <span><strong><?php echo e(number_format($totalWhatsapp)); ?></strong> logs</span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div class="glass-card rounded-2xl p-4 border border-slate-200/80 dark:border-white/10">
            ...
            <h3 class="text-xl font-black text-slate-900 dark:text-white"><?php echo e(number_format($totalLogs)); ?></h3>
        ...
        <div class="glass-card rounded-2xl p-4 border border-slate-200/80 dark:border-white/10">
            ...
            <h3 class="text-xl font-black text-emerald-600 dark:text-emerald-400"><?php echo e(number_format($totalSent)); ?></h3>
        ...
        <div class="glass-card rounded-2xl p-4 border border-slate-200/80 dark:border-white/10">
            ...
            <h3 class="text-xl font-black text-amber-500"><?php echo e(number_format($totalSkipped)); ?></h3>
        ...
        <div class="glass-card rounded-2xl p-4 border border-slate-200/80 dark:border-white/10">
            ...
            <h3 class="text-xl font-black text-rose-500"><?php echo e(number_format($totalFailed)); ?></h3>
    ...
    <!-- Filter & Search Card -->
    <div class="glass-card rounded-2xl p-4 border border-slate-200/80 dark:border-white/10">
        <form method="GET" action="<?php echo e(route('admin.notifications.index')); ?>" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 items-end">
            <!-- Search -->
            <div>
                <label class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Search</label>
                <div class="relative">
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Recipient, email, phone..." class="w-full pl-8 pr-3 py-2 text-xs rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:outline-none focus:ring-2 focus:ring-teal-500 text-slate-800 dark:text-white">
            ...
            <div>
                ...
                <select name="status" class="w-full px-3 py-2 text-xs rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:outline-none focus:ring-2 focus:ring-teal-500 text-slate-800 dark:text-white">
                    ...
                    <option value="skipped" <?php echo e(request('status') === 'skipped' ? 'selected' : ''); ?>>Skipped</option>
            ...
            <div>
                ...
                <select name="event" class="w-full px-3 py-2 text-xs rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:outline-none focus:ring-2 focus:ring-teal-500 text-slate-800 dark:text-white">
                    ...
                    <?php $__currentLoopData = $uniqueEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($evt); ?>" <?php echo e(request('event') === $evt ? 'selected' : ''); ?>>
                            <?php echo e(\App\Models\NotificationLog::eventLabel($evt)); ?>
            ...
            <div class="flex items-center gap-2">
                ...
                <?php if(request()->hasAny(['search', 'channel', 'status', 'event'])): ?>
                    <a href="<?php echo e(route('admin.notifications.index')); ?>" class="px-3 py-2 rounded-xl bg-slate-100 dark:bg-white/10 hover:bg-slate-200 text-slate-600 dark:text-slate-300 text-xs font-bold transition" title="Reset Filters">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-white/[0.02] transition">
                            ...
                            <td class="py-3 px-4 font-semibold">
                                ...
                                <?php else: ?>
                                    <span class="px-2 py-1 rounded bg-slate-100 dark:bg-white/10 font-mono"><?php echo e($log->channel); ?></span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="py-3 px-4">
                                <span class="font-bold text-slate-900 dark:text-white block">
                                    <?php echo e(\App\Models\NotificationLog::eventLabel($log->event)); ?>

                                </span>
                                <span class="text-[10px] text-slate-400 font-mono"><?php echo e($log->event); ?></span>
                            </td>

                            <!-- Recipient -->
                            <td class="py-3 px-4 font-medium">
                                <?php echo e($log->recipient_name ?: ($log->notifiable?->name ?? 'System')); ?>

                            </td>

                            <!-- Contact -->
                            <td class="py-3 px-4 font-mono text-[11px]">
                                <?php echo e($log->recipient_contact ?: '—'); ?>
                            ...
                            <td class="py-3 px-4">
                                ...
                                <?php elseif($log->status === 'skipped'): ?>
                                    <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-amber-100 text-amber-800 dark:bg-amber-500/20 dark:text-amber-400" title="<?php echo e($log->error_message ?? 'Skipped (channel disabled)'); ?>">
                                        <i class="fas fa-forward text-[9px]"></i> Skipped
                                    </span>
                                <?php elseif($log->status === 'failed'): ?>
                                    <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-rose-100 text-rose-700 dark:bg-rose-500/20 dark:text-rose-400" title="<?php echo e($log->error_message); ?>">
                                        <i class="fas fa-triangle-exclamation text-[9px]"></i> Failed
                                    </span>
                                <?php else: ?>
                                    <span class="px-2 py-0.5 rounded text-[10px] font-mono bg-slate-100"><?php echo e($log->status); ?></span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="py-3 px-4 text-slate-500 text-[11px] whitespace-nowrap">
                                ...
                                <div class="text-[10px] text-slate-400"><?php echo e($log->created_at->format('h:i A')); ?></div>
                            </td>

                            <!-- Details -->
                            <td class="py-3 px-4 text-right">
                                <?php if($log->error_message): ?>
                                    <button type="button" onclick="alert('Log ID: <?php echo e($log->id); ?>\n\nError:\n<?php echo e(addslashes($log->error_message)); ?>')" class="p-1.5 rounded-lg text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition" title="View Error">
...
<div id="testNotificationModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-white/10 shadow-2xl max-w-md w-full p-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.notifications.test')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Employee\Desktop\outsourcelab\resources\views/admin/pages/notifications/index.blade.php ENDPATH**/ ?>