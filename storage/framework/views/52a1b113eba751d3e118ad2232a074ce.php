...
<div class="space-y-8 animate-fade-in">
        ...
        <div class="xl:col-span-2 space-y-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="glass-card rounded-2xl p-5 relative overflow-hidden group hover:scale-[1.02] transition-all duration-300">
                        <div class="flex justify-between items-start">
                            <div>
                                <div class="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white mb-1 tracking-tight">
                                    ₹<?php echo e(number_format($totalRevenue ?? 0, 0)); ?>
                        ...
                        <div class="mt-3 flex items-center text-[11px] text-indigo-600 dark:text-indigo-400 font-medium">
                            <i class="fas fa-layer-group mr-1"></i> <?php echo e($totalBookings ?? 0); ?> Bookings total
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('admin.packages.index')); ?>" class="text-xs font-semibold text-indigo-500 hover:text-indigo-400 flex items-center gap-1 transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Package Card 1 -->
                    <?php if(isset($featuredPackages[0])): ?>
                    <div class="glass-card rounded-2xl p-5 relative overflow-hidden group hover:scale-[1.01] transition-all">
                            ...
                            <div class="flex items-center space-x-3.5">
                                ...
                                <div>
                                    <h4 class="font-bold text-slate-900 dark:text-white text-sm group-hover:text-indigo-400 transition-colors">
                                        <?php echo e($featuredPackages[0]->name); ?>

                                    </h4>
                                    <div class="flex items-center space-x-3 text-[11px] text-slate-400 mt-1">
                                        <span class="flex items-center gap-1"><i class="fas fa-vial text-emerald-400"></i> ₹<?php echo e($featuredPackages[0]->price); ?></span>
                        ...
                        <div class="space-y-2 mt-4 pt-4 border-t border-slate-100 dark:border-white/[0.06]">
                            ...
                            <div class="flex justify-between items-center pt-2">
                                ...
                                <a href="<?php echo e(route('admin.packages.edit', $featuredPackages[0]->id)); ?>" class="px-3.5 py-1.5 rounded-lg bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-500 dark:text-indigo-400 border border-indigo-500/30 text-xs font-semibold transition-all">
                                    Manage
                                </a>
                            </div>
                        </div>
                    ...
                    <!-- Package Card 2 -->
                    <?php if(isset($featuredPackages[1])): ?>
                    <div class="glass-card rounded-2xl p-5 relative overflow-hidden group hover:scale-[1.01] transition-all">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center space-x-3.5">
                                ...
                                <div>
                                    <h4 class="font-bold text-slate-900 dark:text-white text-sm group-hover:text-indigo-400 transition-colors">
                                        <?php echo e($featuredPackages[1]->name); ?>

                                    </h4>
                                    <div class="flex items-center space-x-3 text-[11px] text-slate-400 mt-1">
                                        <span class="flex items-center gap-1"><i class="fas fa-vial text-purple-400"></i> ₹<?php echo e($featuredPackages[1]->price); ?></span>
                                        <span class="text-slate-500">•</span>
                        ...
                        <div class="space-y-2 mt-4 pt-4 border-t border-slate-100 dark:border-white/[0.06]">
                            ...
                            <div class="flex justify-between items-center pt-2">
                                <span class="text-[11px] text-slate-400">Active in Catalog</span>
                                <a href="<?php echo e(route('admin.packages.edit', $featuredPackages[1]->id)); ?>" class="px-3.5 py-1.5 rounded-lg bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-500 dark:text-indigo-400 border border-indigo-500/30 text-xs font-semibold transition-all">
                                    Manage
                                </a>
                            </div>
                        </div>
            ...
            <div class="glass-card rounded-2xl p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-xs text-slate-400 font-medium">(<?php echo e(now()->format('M d')); ?> - <?php echo e(now()->addDays(14)->format('M d')); ?>)</span>
                    </div>
                    <div class="flex items-center space-x-2">
                    ...
                    <?php for($i = 1; $i <= 14; $i++): ?>
                        ...
                        <div class="flex flex-col items-center flex-shrink-0 cursor-pointer group">
                            <span class="text-[10px] uppercase font-bold text-slate-400 mb-1.5 group-hover:text-indigo-400">
                                <?php echo e($dayDate->format('D')[0]); ?>

                            </span>
                            <div class="w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold transition-all <?php echo e($isSelected ? 'bg-gradient-to-tr from-indigo-600 to-purple-600 text-white shadow-lg shadow-indigo-500/40 ring-4 ring-indigo-500/20' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-white/[0.06]'); ?>">
                ...
                <div class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $recentBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="flex items-center space-x-4 p-3.5 rounded-xl hover:bg-slate-100 dark:hover:bg-white/[0.03] transition-colors group">
                            ...
                            <!-- Vertical Bar Accent -->
                            <div class="w-1 h-9 rounded-full <?php echo e($booking->status == 'Completed' ? 'bg-emerald-500' : ($booking->status == 'Pending' ? 'bg-amber-500' : 'bg-indigo-500')); ?> flex-shrink-0"></div>

                            <!-- Appointment Info -->
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between">
                                    <h5 class="text-sm font-bold text-slate-900 dark:text-white truncate">
                                        <?php echo e($booking->patient->name ?? 'Patient Record'); ?> 
                                        <span class="text-xs font-normal text-slate-400">(#<?php echo e($booking->booking_reference); ?>)</span>
                                    </h5>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <a href="<?php echo e(route('admin.bookings.show', $booking->id)); ?>" class="w-7 h-7 rounded-full border border-slate-300 dark:border-white/[0.2] flex items-center justify-center text-slate-400 hover:text-white hover:border-indigo-400 transition-colors">
                                            <i class="fas fa-chevron-right text-[10px]"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2 text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
                                    <span>₹<?php echo e($booking->amount); ?></span>
                                    <span>•</span>
                                    <span class="font-medium <?php echo e($booking->status == 'Completed' ? 'text-emerald-400' : ($booking->status == 'Pending' ? 'text-amber-400' : 'text-indigo-400')); ?>">
        ...
        <div class="space-y-8">
            ...
            <div class="glass-card rounded-2xl p-6 text-center relative overflow-hidden">
                ...
                <div class="grid grid-cols-3 gap-2 mt-6 pt-6 border-t border-slate-100 dark:border-white/[0.06]">
                    ...
                    <div>
                        <div class="text-lg font-bold text-slate-900 dark:text-white"><?php echo e($activeTests ?? 18); ?></div>
            ...
            <div class="glass-card rounded-2xl p-6 relative overflow-hidden">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-base font-bold text-slate-900 dark:text-white">Statistics on <?php echo e(now()->format('F')); ?></h3>
                </div>
    ...
    <div class="glass-card rounded-2xl overflow-hidden border border-slate-200 dark:border-white/[0.08]">
        <div class="p-6 border-b border-slate-100 dark:border-white/[0.06] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('admin.bookings.index')); ?>" class="px-4 py-2 rounded-xl bg-slate-100 dark:bg-white/[0.06] hover:bg-slate-200 dark:hover:bg-white/[0.1] text-indigo-500 dark:text-indigo-400 text-xs font-semibold transition-all inline-flex items-center gap-2 self-start sm:self-auto">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-white/[0.06] text-sm">
                    ...
                    <tr class="hover:bg-slate-50/60 dark:hover:bg-white/[0.02] transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="font-medium text-slate-800 dark:text-slate-200"><?php echo e($booking->patient->name ?? 'Guest Patient'); ?></div>
                            <div class="text-xs text-slate-400"><?php echo e($booking->patient->phone ?? ''); ?></div>
                        </td>
                        <td class="px-6 py-4 text-slate-500 dark:text-slate-400 text-xs">
                            <?php echo e($booking->booking_date ? $booking->booking_date->format('M d, Y h:i A') : 'N/A'); ?>

                        </td>
                        <td class="px-6 py-4 font-bold text-slate-800 dark:text-slate-200">
                            ₹<?php echo e(number_format($booking->amount, 2)); ?>

                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                                <?php echo e($booking->status == 'Completed' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/30' : 
                                ...
                                <span class="w-1.5 h-1.5 rounded-full mr-1.5 <?php echo e($booking->status == 'Completed' ? 'bg-emerald-400' : ($booking->status == 'Pending' ? 'bg-amber-400' : ($booking->status == 'Cancelled' ? 'bg-rose-400' : 'bg-indigo-400'))); ?>"></span>
                                <?php echo e($booking->status); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 text-right space-x-2">
                            <a href="<?php echo e(route('admin.bookings.show', $booking->id)); ?>" class="inline-flex items-center px-3 py-1.5 rounded-lg bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 text-xs font-semibold transition-colors">
...
<?php echo $__env->make('admin.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\outsourcelab\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>