                    ...
                    <div class="flex h-full flex-col bg-white shadow-xl">
                        ...
                        <div class="relative flex-1 px-4 py-6 sm:px-6 overflow-y-auto bg-gray-50/50">
                            <div class="space-y-4" id="addressList">
                                <?php $__empty_1 = true; $__currentLoopData = ($patient->addresses ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $addr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <label class="block cursor-pointer">
                                    <input type="radio" name="selected_address" value="<?php echo e($addr->id); ?>" class="peer hidden" <?php echo e($index === 0 ? 'checked' : ''); ?> data-id="<?php echo e($addr->id); ?>" data-type="<?php echo e($addr->title ?? 'Home'); ?>" data-address="<?php echo e($addr->full_address); ?>" data-pincode="<?php echo e($addr->pincode); ?>">
                                    <div class="border border-gray-200 bg-white rounded-xl p-4 peer-checked:border-brand-dark peer-checked:bg-brand-light/10 transition shadow-sm">
                                        <div class="flex items-start">
                                            <div class="pt-1 mr-3 text-gray-400 peer-checked:text-brand-dark">
                                                <i class="fas <?php echo e(strtolower($addr->title) === 'office' ? 'fa-building' : 'fa-home'); ?>"></i>
                                            </div>
                                            <div class="flex-1">
                                                <h4 class="font-bold text-gray-800 text-sm"><?php echo e($addr->title ?? 'Address'); ?></h4>
                                                <p class="text-xs text-gray-500 mt-1 leading-relaxed"><?php echo e($addr->full_address); ?> - <?php echo e($addr->pincode); ?></p>
                                            </div>
...
<?php /**PATH C:\Users\Employee\Desktop\outsourcelab\resources\views/patient/modals/change-address.blade.php ENDPATH**/ ?>