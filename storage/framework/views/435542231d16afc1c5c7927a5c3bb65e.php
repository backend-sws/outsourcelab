...
<section id="single-health-checkup" class="container mx-auto px-4 py-8 scroll-mt-24">
    ...
    <div class="flex flex-col sm:flex-row sm:items-end justify-between mb-6 gap-4">
        ...
        <div class="flex items-center space-x-3 self-end sm:self-auto">
            <span class="text-xs text-gray-500 font-medium hidden md:inline-block">
                Showing <?php echo e(count($singleTests ?? [])); ?> Active Tests
            </span>
    ...
    <div class="swiper singleTestsSwiper overflow-hidden !py-3">
        <div class="swiper-wrapper">
            <?php $__empty_1 = true; $__currentLoopData = $singleTests ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="bg-white rounded-[2rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col justify-between hover:-translate-y-1 hover:shadow-[0_12px_35px_rgb(0,0,0,0.08)] transition-all duration-300 relative group overflow-hidden h-full">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between items-center mb-3">
                                ...
                                <div class="flex items-center gap-1 flex-wrap max-w-[80%]">
                                    <?php if($testCats->count() > 0): ?>
                                        <?php $__currentLoopData = $testCats->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($testCats->count() > 2): ?>
                                            <span class="text-[9px] text-teal-600 font-bold">+<?php echo e($testCats->count() - 2); ?></span>
                                        <?php endif; ?>
                                    <?php else: ?>
                            ...
                            <!-- Test Name -->
                            <h3 class="font-bold text-gray-900 text-sm leading-snug mb-3 group-hover:text-teal-700 transition-colors line-clamp-2 min-h-[40px]" title="<?php echo e($test->name); ?>">
                                <a href="<?php echo e(route('test.show', $test->id)); ?>" class="hover:underline">
                            ...
                            <div class="bg-gray-50/80 rounded-xl p-2.5 flex items-center justify-between mb-3 border border-gray-200/60 text-center">
                                <div class="w-1/2 pr-2">
                                    ...
                                    <span class="font-bold text-gray-800 text-[11px] flex items-center justify-center gap-1 mt-0.5">
                                        ...
                                        <?php echo e($test->report_delivery_time ?? 'Same Day'); ?>
                                ...
                                <div class="w-1/2 pl-2">
                                    ...
                                    <span class="font-bold text-emerald-600 text-[11px] flex items-center justify-center gap-1 mt-0.5">
                                        ...
                                        <?php echo e($test->home_collection_available ? 'Home Pickup' : 'Lab Visit'); ?>
                            ...
                            <div class="text-[11px] text-gray-500 mb-4 flex items-center gap-1.5">
                                ...
                                <span class="truncate" title="<?php echo e($test->preparation_instructions ?? 'Standard Blood Sample'); ?>">
                                    <?php echo e($test->preparation_instructions ?? 'Standard Sample • Certified Lab'); ?>
                        ...
                        <div class="border-t border-gray-100 pt-3 mt-auto">
                            ...
                            <div class="flex items-baseline justify-between mb-3">
                                <div>
                                    <div class="flex items-center gap-1.5 mb-0.5">
                                        <span class="text-xs text-gray-400 line-through">₹<?php echo e($mrp); ?></span>
                                    ...
                                    <div class="text-2xl font-black text-gray-900 tracking-tight">
                                        ₹<?php echo e(number_format($test->price, 0)); ?>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <a href="<?php echo e(route('test.show', $test->id)); ?>" class="w-full bg-teal-50 hover:bg-teal-100 text-teal-800 font-bold py-2 rounded-xl transition text-xs flex items-center justify-center gap-1 border border-teal-200/60">
                                    <i class="fas fa-file-waveform text-[10px]"></i> Info
                                </a>
                                <button onclick="addToCart(this)" 
                                    data-id="<?php echo e($test->id); ?>"
                                    data-type="test"
                                    data-name="<?php echo e($test->name); ?>"
                                    data-price="<?php echo e($test->price); ?>"
                                    data-mrp="<?php echo e($mrp); ?>"
                                    data-params="<?php echo e($test->preparation_instructions ?? 'Single Diagnostic Test'); ?>"
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="swiper-slide !w-full">
                    <div class="bg-white rounded-2xl p-8 border border-gray-100 text-center shadow-sm w-full">
                        ...
                        <a href="<?php echo e(route('admin.tests.create')); ?>" class="px-4 py-2 rounded-full bg-brand-primary text-white text-xs font-bold inline-block">
...
<?php /**PATH C:\Users\Employee\Desktop\outsourcelab\resources\views/frontend/partials/single-tests-section.blade.php ENDPATH**/ ?>