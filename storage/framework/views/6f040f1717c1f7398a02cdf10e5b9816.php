...
<head>
    ...
    <title><?php echo e($title ?? config('app.name', 'AV Wellcare Diagnostics')); ?></title>
    <style>
        body {
            margin: 0;
            padding: 0;
                    ...
                    <div class="container">
                        ...
                        <div class="footer">
                            ...
                            <p style="margin: 12px 0 0; font-size: 11px; color: #cbd5e1;">
                                &copy; <?php echo e(date('Y')); ?> AV Wellcare Diagnostics. All rights reserved.
                            </p>
                        </div>
                    </div>
                </td>
...
<?php /**PATH C:\Users\Employee\Desktop\outsourcelab\resources\views/emails/layouts/base.blade.php ENDPATH**/ ?>