    ...
    <div class="rounded-3xl flex flex-col md:flex-row items-center justify-between p-6 sm:p-8 bg-gradient-to-r from-teal-900 via-teal-800 to-emerald-900 text-white shadow-xl overflow-hidden relative group">
        ...
        <div class="z-10 md:w-3/5">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="#contact-enquiry" class="bg-white/10 hover:bg-white/20 text-white font-bold py-2.5 px-5 rounded-xl transition text-sm border border-white/20 backdrop-blur-sm flex items-center gap-1.5 cursor-pointer">
    ...
    <div class="bg-gradient-to-br from-green-50 to-blue-50 rounded-[40px] p-6 md:p-10 flex flex-col md:flex-row items-center gap-8 border border-green-100 shadow-xl overflow-hidden relative">
        ...
        <div class="md:w-1/3 relative z-10">
            ...
            <div class="flex flex-wrap items-center gap-3 mb-6">
                <a href="#contact-enquiry" class="inline-flex items-center font-bold text-white bg-brand-dark px-6 py-3 rounded-full hover:bg-brand-secondary transition transform hover:scale-105 shadow-lg">Explore GeneCliffe <i class="fas fa-arrow-right ml-2"></i></a>
                <div class="flex space-x-2">
