...
<div class="space-y-6 max-w-4xl">
    ...
    <form action="<?php echo e(route('admin.categories.store')); ?>" method="POST" enctype="multipart/form-data" class="glass-card rounded-2xl p-6 sm:p-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="name" required value="<?php echo e(old('name')); ?>" class="w-full bg-slate-50 dark:bg-[#0a0b1c]/50 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50" placeholder="e.g. Standard Health Checkup">
                    ...
                    <div class="flex items-start space-x-3 sub-category-row bg-slate-50/50 dark:bg-white/[0.02] p-4 rounded-xl border border-slate-100 dark:border-white/[0.05]">
                        <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="sub_category_name[<?php echo e($index); ?>]" value="<?php echo e($name); ?>" 
                        ...
                        <button type="button" class="remove-btn mt-5 w-10 h-10 flex-shrink-0 flex items-center justify-center rounded-xl bg-rose-50 text-rose-500 hover:bg-rose-100 dark:bg-rose-500/10 dark:text-rose-400 dark:hover:bg-rose-500/20 transition-colors <?php echo e(count($oldNames) === 1 ? 'hidden' : ''); ?>">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let subCatIndex = <?php echo e(max(array_keys($oldNames)) + 1); ?>;
...
<?php echo $__env->make('admin.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\outsourcelab\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>