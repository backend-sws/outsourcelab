...
<div id="prescriptionModal" class="fixed inset-0 z-50 bg-black/60 hidden opacity-0 transition-opacity duration-300 flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl max-w-lg w-full shadow-2xl overflow-hidden transform scale-95 transition-transform duration-300 relative border border-gray-100" id="prescriptionModalCard">
        ...
        <?php if(session('prescription_success')): ?>
            <div class="p-6 bg-emerald-50 border-b border-emerald-100 text-emerald-800 text-xs font-semibold flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 leading-relaxed"><?php echo e(session('prescription_success')); ?></p>
                </div>
            </div>
        <?php endif; ?>

        <form action="<?php echo e(route('prescription.quick_upload')); ?>" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="patient_name" value="<?php echo e(old('patient_name', $patient ? $patient->name : '')); ?>" required placeholder="e.g. Rahul Sharma" class="w-full pl-9 pr-3 py-2.5 text-xs rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-600">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="tel" name="mobile_number" value="<?php echo e(old('mobile_number', $patient ? $patient->phone : '')); ?>" required maxlength="15" placeholder="e.g. 9876543210" class="w-full pl-9 pr-3 py-2.5 text-xs rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-600 font-mono">
                </div>
            </div>
...
<?php /**PATH C:\Users\Employee\Desktop\outsourcelab\resources\views/frontend/partials/modals/prescription.blade.php ENDPATH**/ ?>