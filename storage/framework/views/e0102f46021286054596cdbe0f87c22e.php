...
<div class="px-6 py-6 sm:px-8 max-w-4xl mx-auto">
    ...
    <div class="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 shadow-xl overflow-hidden relative">
        ...
        <form action="<?php echo e(route('admin.departments.store')); ?>" method="POST" class="p-8">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\outsourcelab\resources\views/admin/test_categories/create.blade.php ENDPATH**/ ?>