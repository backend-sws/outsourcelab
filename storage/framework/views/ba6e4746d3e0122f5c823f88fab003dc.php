...
<head>
    ...
    <title>WellCare Admin — <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-[#051210] border-r border-slate-200 dark:border-teal-900/50 transform -translate-x-full md:relative md:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col justify-between flex-shrink-0 h-full">
            ...
            <div>
                <div class="h-[72px] flex items-center justify-between px-5 border-b border-slate-100 dark:border-teal-900/40">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center space-x-3 group">
                        <img src="<?php echo e(asset('logo.png')); ?>" alt="AV Wellcare Diagnostics" class="h-9 w-auto object-contain group-hover:scale-105 transition-transform">
                ...
                <div class="py-4 px-3.5 space-y-5 overflow-y-auto max-h-[calc(100vh-240px)]">
                    ...
                    <div>
                        ...
                        <nav class="space-y-1">
                            ...
                            <!-- Dashboard -->
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.dashboard') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-gauge-high w-5 text-center text-sm <?php echo e(request()->routeIs('admin.dashboard') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                                    <span>Overview</span>
                                </div>
                            ...
                            <!-- Users -->
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.users.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-users w-5 text-center text-sm <?php echo e(request()->routeIs('admin.users.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                                    <span>Users</span>
                                </div>
                            ...
                            <!-- Bookings -->
                            <a href="<?php echo e(route('admin.bookings.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.bookings.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-calendar-check w-5 text-center text-sm <?php echo e(request()->routeIs('admin.bookings.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                                    <span>Bookings</span>
                                </div>
                            ...
                            <a href="<?php echo e(route('admin.transactions.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.transactions.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-receipt w-5 text-center text-sm <?php echo e(request()->routeIs('admin.transactions.*') ? 'text-emerald-400' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                            ...
                            <!-- Field Agents -->
                            <a href="<?php echo e(route('admin.agents.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.agents.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-id-badge w-5 text-center text-sm <?php echo e(request()->routeIs('admin.agents.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                            ...
                            <!-- Notifications -->
                            <a href="<?php echo e(route('admin.notifications.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.notifications.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-bell w-5 text-center text-sm <?php echo e(request()->routeIs('admin.notifications.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                    ...
                    <div>
                        ...
                        <nav class="space-y-1">
                            ...
                            <!-- Audience Categories -->
                            <a href="<?php echo e(route('admin.categories.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.categories.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-tags w-5 text-center text-sm <?php echo e(request()->routeIs('admin.categories.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                            ...
                            <a href="<?php echo e(route('admin.departments.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.departments.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-microscope w-5 text-center text-sm <?php echo e(request()->routeIs('admin.departments.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                            ...
                            <!-- Single Lab Tests -->
                            <a href="<?php echo e(route('admin.tests.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.tests.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-vial w-5 text-center text-sm <?php echo e(request()->routeIs('admin.tests.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                            ...
                            <!-- Health Packages -->
                            <a href="<?php echo e(route('admin.packages.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.packages.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-boxes-stacked w-5 text-center text-sm <?php echo e(request()->routeIs('admin.packages.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                    ...
                    <div>
                        ...
                        <nav class="space-y-1">
                            ...
                            <!-- Patient Reviews -->
                            <a href="<?php echo e(route('admin.reviews.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.reviews.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-star-half-stroke w-5 text-center text-sm <?php echo e(request()->routeIs('admin.reviews.*') ? 'text-amber-400' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                            ...
                            <!-- Enquiries -->
                            <a href="<?php echo e(route('admin.enquiries.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.enquiries.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-comment-dots w-5 text-center text-sm <?php echo e(request()->routeIs('admin.enquiries.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                                    <span>Enquiries</span>
                                </div>
                                <i class="fas fa-chevron-right text-[10px] text-slate-300 dark:text-slate-600"></i>
                            </a>
                    ...
                    <div>
                        ...
                        <nav class="space-y-1">
                            ...
                            <!-- Coupons -->
                            <a href="<?php echo e(route('admin.coupons.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.coupons.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-ticket-alt w-5 text-center text-sm <?php echo e(request()->routeIs('admin.coupons.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                                    <span>Coupons</span>
                                </div>
                            ...
                            <!-- VIP Memberships -->
                            <a href="<?php echo e(route('admin.memberships.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.memberships.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-crown w-5 text-center text-sm <?php echo e(request()->routeIs('admin.memberships.*') ? 'text-amber-400' : 'text-amber-400/60'); ?>"></i>
                                    <span>VIP Memberships</span>
                                </div>
                                <?php if(request()->routeIs('admin.memberships.*')): ?>
                            ...
                            <!-- Rewards & Coins -->
                            <a href="<?php echo e(route('admin.rewards.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.rewards.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-coins w-5 text-center text-sm <?php echo e(request()->routeIs('admin.rewards.*') ? 'text-yellow-400' : 'text-yellow-400/60'); ?>"></i>
                                    <span>Rewards & Coins</span>
                                </div>
                                <?php if(request()->routeIs('admin.rewards.*')): ?>
                            ...
                            <!-- Site Settings -->
                            <a href="<?php echo e(route('admin.settings.index')); ?>" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('admin.settings.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20'); ?>">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-sliders w-5 text-center text-sm <?php echo e(request()->routeIs('admin.settings.*') ? 'text-teal-500' : 'text-slate-400 dark:text-slate-500'); ?>"></i>
                    ...
                    <div>
                        ...
                        <nav class="space-y-1">
                            <a href="<?php echo e(url('/')); ?>" target="_blank" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-all">
                                <div class="flex items-center space-x-3">
                            ...
                            <a href="<?php echo e(route('agent.login')); ?>" target="_blank" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-all">
                                <div class="flex items-center space-x-3">
            ...
            <div class="p-3.5 border-t border-slate-100 dark:border-teal-900/40 space-y-3">
                ...
                <div class="relative overflow-hidden rounded-2xl p-3.5 bg-gradient-to-br from-teal-900/70 via-teal-800/40 to-slate-900/80 border border-teal-700/30 text-white">
                    ...
                    <a href="<?php echo e(route('admin.bookings.index')); ?>" class="block w-full text-center py-2 px-3 rounded-xl bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-500 hover:to-teal-600 text-white text-xs font-semibold shadow-md shadow-teal-700/30 transition-all">
                        Check Live Bookings
                    </a>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2.5 text-sm">
                        ...
                        <div class="flex items-center space-x-2 font-medium text-xs sm:text-sm">
                            ...
                            <span class="text-slate-800 dark:text-white font-semibold"><?php echo $__env->yieldContent('header', 'Overview'); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-2 sm:space-x-4">
                    ...
                    <div class="relative" id="adminNotifDropdownContainer">
                        ...
                        <div id="adminNotifMenu" class="hidden slide-in-up absolute right-0 mt-2 w-80 sm:w-96 rounded-2xl bg-white dark:bg-[#071a18] border border-slate-200 dark:border-teal-900/50 shadow-2xl shadow-black/30 z-50 overflow-hidden">
                            ...
                            <div class="p-2.5 bg-slate-50 dark:bg-teal-950/20 border-t border-slate-100 dark:border-teal-900/40 text-center">
                                <a href="<?php echo e(route('admin.notifications.index')); ?>" class="text-xs font-bold text-teal-600 dark:text-teal-400 hover:underline flex items-center justify-center gap-1.5 py-1">
                    ...
                    <div class="relative pl-1">
                        ...
                        <div id="profileDropdownMenu" class="hidden slide-in-up absolute right-0 mt-2 w-60 rounded-2xl bg-white dark:bg-[#071a18] border border-slate-200 dark:border-teal-900/50 shadow-2xl shadow-black/30 py-2 z-50">
                            ...
                            <div class="py-1">
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center space-x-2.5 px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors">
                                    <i class="fas fa-chart-line w-4 text-teal-500"></i>
                                    <span>Dashboard Overview</span>
                                </a>
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center space-x-2.5 px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors">
                                    <i class="fas fa-users w-4 text-teal-500"></i>
                                    <span>Manage Users</span>
                                </a>
                                <a href="<?php echo e(route('admin.bookings.index')); ?>" class="flex items-center space-x-2.5 px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors">
                                    <i class="fas fa-calendar-check w-4 text-teal-500"></i>
                                    <span>All Bookings</span>
                                </a>
                                <a href="<?php echo e(url('/')); ?>" target="_blank" class="flex items-center space-x-2.5 px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.loadAdminNotifications = function() {
                fetch("<?php echo e(route('admin.notifications.unreadFeed')); ?>", {
            ...
            window.handleAdminNotifClick = function(notifId, actionUrl) {
                fetch(`<?php echo e(url('/admin/notifications/mark-read')); ?>/${notifId}`, {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\Users\Employee\Desktop\outsourcelab\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>