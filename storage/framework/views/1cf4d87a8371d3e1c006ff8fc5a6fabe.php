            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <div class="flex space-x-4 mb-8">
                        <a href="<?php echo e($insta); ?>" target="_blank" rel="noopener" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-instagram"></i></a>
                        <a href="<?php echo e($fb); ?>" target="_blank" rel="noopener" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-facebook-f"></i></a>
                        <a href="<?php echo e($twitter); ?>" target="_blank" rel="noopener" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-twitter"></i></a>
                        <a href="<?php echo e($linkedin); ?>" target="_blank" rel="noopener" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-linkedin-in"></i></a>
                        <a href="<?php echo e($yt); ?>" target="_blank" rel="noopener" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-secondary transition text-sm"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-xs text-gray-300">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <strong class="text-white block mb-1"><?php echo e($companyName); ?></strong>
                                <p class="mb-2"><strong>Registered Address:</strong><br><?php echo e($registeredAddr); ?></p>
                                <p><strong>National Reference Lab:</strong><br><?php echo e($nationalRefLab); ?></p>
                            </div>
                        </li>
                    </ul>
