                    ...
                    <?php if(!empty($parameters) && count($parameters) > 0): ?>
                        <?php $__currentLoopData = $parameters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $parameter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-2 parameter-row">
                                <input type="text" name="parameters[]" value="<?php echo e($parameter); ?>" placeholder="e.g. Complete Blood Count (CBC)" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm px-4 py-2 border bg-gray-50">
...
<?php echo $__env->make('admin.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\lab\lab\resources\views/admin/packages/form.blade.php ENDPATH**/ ?>