    ...
    <div class="flex flex-col md:flex-row gap-8 justify-center">
        ...
        <div class="w-full md:w-2/3 lg:w-1/2">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
                <form action="<?php echo e(route('patient.profile.store')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    <!-- Full Name -->
                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-2">Enter Full Name</label>
                        <input type="text" name="name" value="<?php echo e($profile['name'] ?? ''); ?>" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-secondary focus:border-brand-secondary font-bold text-gray-800 outline-none" required>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4">
                            <label class="flex-1">
                                <input type="radio" name="gender" value="female" <?php echo e((strtolower($profile['gender'] ?? '') === 'female') ? 'checked' : ''); ?> class="peer hidden">
                            ...
                            <label class="flex-1">
                                <input type="radio" name="gender" value="male" <?php echo e((strtolower($profile['gender'] ?? '') === 'male') ? 'checked' : ''); ?> class="peer hidden">
                                <div class="border border-gray-200 rounded-full py-2.5 text-center cursor-pointer font-bold text-gray-400 peer-checked:bg-brand-light/10 peer-checked:text-brand-dark peer-checked:border-brand-dark transition flex items-center justify-center">
                    ...
                    <div class="flex space-x-4">
                        <div class="flex-1">
                            ...
                            <input type="number" name="age" value="<?php echo e($profile['age'] !== '-' ? $profile['age'] : ''); ?>" placeholder="Enter Age" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-secondary focus:border-brand-secondary font-bold text-gray-800 outline-none placeholder-gray-300">
                        </div>
                        ...
                        <div class="flex-1 relative">
                            ...
                            <input type="date" name="dob" value="<?php echo e($profile['dob'] ?? ''); ?>" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-secondary focus:border-brand-secondary font-bold text-gray-800 outline-none text-gray-400">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <label>
                                <input type="radio" name="relation" value="self" <?php echo e(($profile['relation'] ?? 'self') === 'self' ? 'checked' : ''); ?> class="peer hidden">
                            ...
                            <label>
                                <input type="radio" name="relation" value="spouse" <?php echo e(($profile['relation'] ?? '') === 'spouse' ? 'checked' : ''); ?> class="peer hidden">
                            ...
                            <label>
                                <input type="radio" name="relation" value="mother" <?php echo e(($profile['relation'] ?? '') === 'mother' ? 'checked' : ''); ?> class="peer hidden">
                            ...
                            <label>
                                <input type="radio" name="relation" value="father" <?php echo e(($profile['relation'] ?? '') === 'father' ? 'checked' : ''); ?> class="peer hidden">
                            ...
                            <label>
                                <input type="radio" name="relation" value="daughter" <?php echo e(($profile['relation'] ?? '') === 'daughter' ? 'checked' : ''); ?> class="peer hidden">
                    ...
                    <div>
                        <div class="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 relative">
                            ...
                            <span class="font-bold text-gray-800 text-lg"><?php echo e($profile['mobile'] ?? '9470700693'); ?></span>
                            <!-- Hidden input to still submit mobile if we wanted to -->
                            <input type="hidden" name="mobile" value="<?php echo e($profile['mobile'] ?? '9470700693'); ?>">
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\lab\lab\resources\views/patient/edit-profile.blade.php ENDPATH**/ ?>