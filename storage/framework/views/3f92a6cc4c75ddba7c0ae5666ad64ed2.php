...
document.addEventListener('DOMContentLoaded', function() {
    ...
    registerForm.addEventListener('submit', function(e) {
        ...
        if (currentRegRole === 'agent') {
            ...
            fetch('<?php echo e(route("agent.register")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            ...
            .then(data => {
                if(data.success) {
                    closeLoginModal();
                    window.location.href = data.redirect || '<?php echo e(route("agent.dashboard")); ?>';
                } else {
                    submitBtn.innerHTML = originalText;
                    submitBtn.disabled = false;
...
<?php /**PATH C:\Users\Employee\Desktop\outsourcelab\resources\views/frontend/partials/modals/login.blade.php ENDPATH**/ ?>