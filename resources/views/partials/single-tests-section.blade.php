                        ...
                        <div>
                            ...
                            <div class="flex justify-between items-center mb-3">
                                <span class="bg-teal-50 text-teal-700 text-[10px] font-bold px-2.5 py-1 rounded-full border border-teal-200/60 uppercase tracking-wider">
                                    {{ $test->category->name ?? 'Single Test' }}
                                </span>
                            ...
                            <!-- Test Name -->
                            <h3 class="font-bold text-gray-900 text-sm leading-snug mb-3 group-hover:text-brand-secondary transition-colors line-clamp-2 min-h-[40px]" title="{{ $test->name }}">
                                {{ $test->name }}
                            </h3>
