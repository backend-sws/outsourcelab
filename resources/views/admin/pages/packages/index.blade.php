...
<div class="flex justify-between items-center w-full mb-6">
    ...
    <a href="{{ route('admin.packages.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold py-2 px-4 rounded-lg transition-colors shadow-sm">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-800">
                        ...
                        <div class="mt-1">
                            @if($package->type === 'habit')
                                <span class="bg-teal-50 text-teal-700 text-[10px] font-bold px-2 py-0.5 rounded border border-teal-100">HABIT: {{ strtoupper($package->subcategory) }}</span>
                            @elseif($package->type === 'femcliffe')
                                <span class="bg-pink-50 text-pink-700 text-[10px] font-bold px-2 py-0.5 rounded border border-pink-100">FEMCLIFFE: {{ strtoupper($package->subcategory) }}</span>
                            @else
