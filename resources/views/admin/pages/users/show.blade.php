                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pb-3 border-b border-slate-200/60 dark:border-white/[0.06]">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-[10px] text-slate-500 font-medium">
                                {{ $booking->booking_date ? $booking->booking_date->format('d M, Y') : $booking->created_at->format('d M, Y') }}
                            </span>
                            <span class="inline-flex items-center gap-1 text-[10px] font-bold text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 px-1.5 py-0.5 rounded">
                                <i class="far fa-clock text-[9px]"></i>
                                {{ $booking->display_slot }}
                            </span>
                        </div>
                        <div class="flex items-center gap-2">
                            @php
