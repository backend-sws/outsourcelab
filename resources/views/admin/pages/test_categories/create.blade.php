...
@section('title', 'Add Department & Parameters')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Add a new diagnostic department and configure standard test parameters.</p>
        </div>
    </div>
