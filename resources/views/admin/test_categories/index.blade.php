                    ...
                    <tr class="hover:bg-slate-700/30 transition-colors duration-200 group">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end space-x-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                <!-- Edit Button -->
                                <a href="{{ route('admin.departments.edit', $category->id) }}" class="p-2 text-slate-400 hover:text-brand-primary hover:bg-brand-primary/10 rounded-lg transition-colors" title="Edit">
