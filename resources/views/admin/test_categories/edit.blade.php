...
<div class="px-6 py-6 sm:px-8 max-w-4xl mx-auto">
    ...
    <div class="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 shadow-xl overflow-hidden relative">
        ...
        <form action="{{ route('admin.departments.update', $department->id) }}" method="POST" class="p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <div id="parametersContainer" class="space-y-3">
                    ...
                    <div class="relative group parameter-row">
                        ...
                        <button type="button" class="remove-parameter absolute inset-y-0 right-0 pr-4 flex items-center text-slate-500 hover:text-red-400 transition-colors" style="{{ count($parameters) > 1 ? 'display: flex;' : 'display: none;' }}">
