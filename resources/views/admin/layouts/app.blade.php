                ...
                <div class="py-5 px-4 space-y-6 overflow-y-auto max-h-[calc(100vh-250px)]">
                    ...
                    <div>
                        ...
                        <nav class="space-y-1.5">
                            ...
                            <!-- Categories (Audience Demographics) -->
                            ...
                            <a href="{{ route('admin.departments.index') }}" class="flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('admin.departments.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.04]' }}">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-microscope w-5 text-center text-base {{ request()->routeIs('admin.departments.*') ? 'text-indigo-500 dark:text-indigo-400' : 'text-slate-400' }}"></i>
                                    <span>Departments & Parameters</span>
                                </div>
                                <i class="fas fa-chevron-right text-xs text-slate-400 dark:text-slate-400"></i>
                            </a>
                            ...
                            <a href="{{ route('admin.tests.index') }}" class="flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('admin.tests.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.04]' }}">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-vial w-5 text-center text-base {{ request()->routeIs('admin.tests.*') ? 'text-indigo-500 dark:text-indigo-400' : 'text-slate-400' }}"></i>
                            ...
                            <a href="{{ route('admin.packages.index') }}" class="flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('admin.packages.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.04]' }}">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-boxes-stacked w-5 text-center text-base {{ request()->routeIs('admin.packages.*') ? 'text-indigo-500 dark:text-indigo-400' : 'text-slate-400' }}"></i>
                    ...
                    <div>
                        ...
                        <nav class="space-y-1.5">
                            ...
                            <!-- VIP Memberships -->
                            <a href="{{ route('admin.memberships.index') }}" class="flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('admin.memberships.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.04]' }}">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-crown w-5 text-center text-base {{ request()->routeIs('admin.memberships.*') ? 'text-amber-500' : 'text-amber-400' }}"></i>
                            ...
                            <!-- Health Coins & Rewards -->
                            <a href="{{ route('admin.rewards.index') }}" class="flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('admin.rewards.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.04]' }}">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-coins w-5 text-center text-base {{ request()->routeIs('admin.rewards.*') ? 'text-yellow-500' : 'text-yellow-400' }}"></i>
                            ...
                            <!-- Site Settings / CMS -->
                            <a href="{{ route('admin.settings.index') }}" class="flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('admin.settings.*') ? 'sidebar-item-active' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.04]' }}">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-sliders w-5 text-center text-base {{ request()->routeIs('admin.settings.*') ? 'text-indigo-500 dark:text-indigo-400' : 'text-slate-400' }}"></i>
