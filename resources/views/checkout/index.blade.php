            ...
            <div class="lg:w-2/3">
                ...
                <div id="step1" class="step-content">
                    <div class="flex justify-between items-end mb-4">
                        ...
                        <button class="text-brand-secondary font-bold text-sm border-b-2 border-brand-secondary border-dashed hover:text-brand-dark">+ Add More Tests</button>
                    </div>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mb-4 relative">
                        <button class="absolute top-4 right-4 text-gray-300 hover:text-red-500 transition"><i class="far fa-times-circle text-xl"></i></button>
                        <h3 class="text-red-500 font-bold text-lg w-5/6 leading-tight mb-4">Fit India Full Body Checkup With Vitamin Screening with Free Heart Test (HsCRP)</h3>
                        <div class="flex justify-between items-center">
                            <span class="text-xs font-bold text-gray-800">Includes 96 Parameters <i class="fas fa-chevron-right text-gray-400 ml-1"></i></span>
                            <div class="flex items-center gap-2">
                                <span class="text-xl font-black text-gray-800">₹1799</span>
                                <span class="text-sm font-bold text-gray-400 line-through">₹8566</span>
                    ...
                    <!-- Cart Item 2 -->
                    <div class="bg-blue-50/50 border border-brand-light border-dashed rounded-xl p-6 relative">
                        <h3 class="text-brand-dark font-bold text-lg mb-4">Heart risks hiding silently? One test. Get clarity.</h3>
                        <div class="bg-white border border-gray-200 rounded-xl p-4 flex justify-between items-center shadow-sm">
                            <span class="text-red-500 font-bold">Apolipoprotein B Test</span>
                            <button class="border border-gray-300 rounded px-4 py-1 text-sm font-bold hover:bg-gray-50">+ Add</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="addressAndSlotSection" class="hidden">
                        <div class="border border-gray-200 rounded-xl p-4 flex justify-between items-center mb-8 bg-white shadow-sm">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-800 text-sm">Collection Address <span class="bg-brand-light/30 text-brand-dark text-[10px] px-2 py-0.5 rounded ml-2">Home</span></h4>
                                    <p class="text-xs text-gray-500 mt-1">3rd Floor, Parvati Tower, Phulwari Rd, Jagdeo Path...</p>
                                </div>
                            </div>
                            <button class="text-brand-dark font-bold text-xs border-b border-brand-dark border-dashed hover:text-brand-secondary">Change</button>
                        </div>
            ...
            <div class="lg:w-1/3">
                <div class="sticky top-24">
                        ...
                        <div class="border border-gray-200 rounded-xl overflow-hidden mb-4 bg-white shadow-sm">
                            <div class="p-4 border-b border-gray-100 space-y-3">
                                <div class="flex justify-between text-sm font-semibold text-gray-600">
                                    ...
                                    <span><span class="line-through text-gray-400 text-xs mr-1">₹8566</span> ₹1799</span>
                                </div>
                                <div class="flex justify-between text-sm font-semibold text-gray-600">
                                    <span>VIP Discount (10%)</span>
                                    <span class="text-green-600">- ₹180</span>
                                </div>
                                <div class="flex justify-between text-sm font-semibold text-gray-600">
                            ...
                            <div class="p-4 bg-gray-50 flex justify-between items-center">
                                ...
                                <span class="font-black text-xl text-brand-dark">₹1767</span>
                            </div>
                        </div>
                    ...
                    <div id="sharedBillBlock" class="hidden border border-gray-200 rounded-xl overflow-hidden mb-4 bg-white shadow-sm">
                        ...
                        <div class="p-4 bg-gray-50 flex justify-between items-center">
                            <span class="font-extrabold text-gray-800">Total Payable</span>
                            <span class="font-black text-xl text-brand-dark">₹1799</span>
                        </div>
                    </div>
                    ...
                    <div id="btnPay" class="hidden flex gap-3 mt-2">
                        <button class="flex-1 bg-gray-200 text-gray-800 font-bold py-3.5 rounded-xl hover:bg-gray-300 transition shadow-sm text-sm">Pay On Collection</button>
